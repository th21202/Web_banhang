...
(function ($) {
   ...
   $(".product-slider").owlCarousel({
    ...
    // product ffilter - index loc san phan
        ...
        success: function (response){
            ...
            if(cartHover_existItem.length) {
                ...
                var newItem =
                    ...
                    '     </td>\n' +
                    '     <td class="si-close">\n' +
                    '         <i onclick="removeCart(\'' + response['cart'].rowId + '\')" class="close"></i>\n' +
                    '     </td>\n' +
                    ' </tr>';
...
function removeCart(rowId) {
    $.ajax({
        ...
        data: {rowId: rowId},
        success: function (response) {
            //cuwr lys phafn cart hover( master-page)
            $('.cart-count').text(response['count']);
            $('.cart-price').text('$' + response['total']);
            $('.select-total h5').text('$' + response['total']);
            ...
            //xuwr lys trong trang /shop/cart
