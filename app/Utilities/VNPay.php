...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "DD93GPAJ"; //Mã website tại VNPAY
    static $vnp_HashSecret = "KSRSCJTSGMVTMQQSTQYGASNYTHGMGULA"; //Chuỗi bí mật
    ...
    static $vnp_Returnurl = "/checkout/vnPayCheck", //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
         ...
         $apiUrl = "https://sandbox.vnpayment.vn/merchant_webapi/api/transaction";
            //Config input format
            //Expire
//    static        $startTime = date("YmdHis");
//    static       $expire = date('YmdHis',strtotime('+15 minutes',strtotime($startTime)));
    /**
