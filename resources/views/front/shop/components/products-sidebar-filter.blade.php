<form action="{{ request()->segment(2) == 'product' ? 'shop' : ''}}">
    ...
    <div class=" filter-widget">
        ...
        <div class="fw-color-choose">
            ...
            <div class="cs-item">
                <input type="radio" id="cs-green" name="green" value="black" onchange="this.form.submit();"
