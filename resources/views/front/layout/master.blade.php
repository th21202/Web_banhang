...
<body>
    ...
    <header class="header-section">
        <div class="header-top">
            <div class="container">
                <div class="ht-left">
                    <div class="mail-serice">
                        <i class="fa fa-envelope"></i>
                        linhvo2612002@gmail.com
                    </div>
                    <div class="phone-serice">
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="index.html">
                                <img src="front/img/logo5.png" height="25" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="#">Áo</a></li>
                            <li><a href="#">Quần</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="newslatter-item">
                        ...
                        <p>Get e-mail updates about our lattesr shop and special offers</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            Copyright @<script>document.write(new data().getFullYear());</script>ALL right reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i>by<a href="" taget="_blank">ThoiTrang</a>
                        </div>
